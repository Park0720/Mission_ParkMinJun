...
public class NotificationServiceTests {
    ...
    void t002() throws Exception {
        ...
        LikeablePerson likeablePerson = likeablePersonService.findByFromInstaMemberIdAndToInstaMemberId(memberUser3.getInstaMember().getId(),memberUser4.getInstaMember().getId()).get();

        // 기존에 호감 표시 : insta_use3 -> insta_user4, 호감사유코드 : 1
        // 바뀐 호감 표시 : insta_use3 -> insta_user4, 호감사유코드 : 2
        likeablePersonService.modifyAttractiveTypeCode(likeablePerson, 2);
